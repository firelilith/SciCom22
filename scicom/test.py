...
from library.iterhelp import sparsify, tail
...
series1 = tail(load_series("series/500y_post_sparse.csv"), 100)
series2 = tail(load_series("series/500y_newt_sparse.csv"), 100)
